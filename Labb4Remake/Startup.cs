...
namespace Labb4Remake
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IPersonInterestRepository<PersonInterest>, PersonInterestRepository>();
            services.AddScoped<ILogic<Website>, WebsiteRepository>();
        }
